...
async def start_spambot():
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await hdk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await sdk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await adk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await bdk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await cdk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await ddk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await edk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await vkk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await kkk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await lkk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await mkk(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await sid(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await shy(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await aan(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await ake(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await eel(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await khu(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await shi(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await yaa(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await dav(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await raj(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@visionuserbots"))
            await put(functions.channels.JoinChannelRequest(channel="@CLAN_CRIMINALS"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
